...
\begin{alltt}
\hlkwd{t.test}\hlstd{(diff} \hlopt{~} \hlstd{instructor,} \hlkwc{data} \hlstd{= prepost)}
\end{alltt}
\begin{verbatim}
## 
## 	Welch Two Sample t-test
## 
## data:  diff by instructor
## t = 1.2198, df = 22.659, p-value = 0.2351
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.6123706  2.3687808
## sample estimates:
## mean in group griffith     mean in group kopp 
##              1.4166667              0.5384615
\end{verbatim}
\end{kframe}
\end{knitrout}
