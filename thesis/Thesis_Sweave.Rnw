...
Before going deep into the app design on the user interface (or ui for short), I invite the reader to experience the app for themself so that the design process makes more sense. The app can be found at https://obewanjacobi.shinyapps.io/logistic. 
